...
router.get('/liste_route',(req, res)=> {
    res.render('liste_handle3', {liste, layout:"liste3"})
})


router.post('/liste_route2',(req, res)=> {
    ...
    function ausgabe(){
        ...
        res.render('liste_handle3', {liste, gesamt, layout:"liste3"})
    }
})
